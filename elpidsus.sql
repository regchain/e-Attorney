...
CREATE TABLE `pasals` (
  ...
  `pasal` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ayat` int(11) NOT NULL,
  `keterangan` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `masa_hukuman_min` int(11) NOT NULL,
  `masa_hukuman_max` int(11) NOT NULL,
  `denda_min` double(15,2) NOT NULL,
  `denda_max` double(15,2) NOT NULL,
