    ...
    <ul class="sidebar-menu" data-widget="tree">
      <li class="treeview">
        ...
        <ul class="treeview-menu" style="display: block;">
          ...
          <li><a href="progress"><i class="fa fa fa-pie-chart text-green"></i> Pidum</a></li>
          <li><a href="progress"><i class="fa fa fa-pie-chart text-orange"></i> Pidsus</a></li>
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li  class="active treeview"><a href="home"><i class="fa fa-mobile"></i> el-PIDSUS</a>
            <ul class="treeview-menu">
              <li  class="active treeview"><a href="home"><i class="glyphicon glyphicon-menu-right"></i> Dir. Penyidikan</a>
            <ul class="treeview-menu">
              <li><a href="{{ route('rp1.index') }}"><i class="fa fa-list-ol"></i> RP-1</a></li>
              <li><a href="{{ route('rp2.index') }}"><i class="fa fa-list-ol"></i> RP-2</a></li>
              <li><a href="{{ route('rp3mum.index') }}"><i class="fa fa-list-ol"></i> RP-3 MUM</a></li>
              <li><a href="{{ route('rp3sus.index') }}"><i class="fa fa-list-ol"></i> RP-3 SUS</a></li>
              <li><a href="{{ url('/obyek') }}"><i class="fa fa-list-ol"></i> RB-1</a></li>
              <li><a href="{{ url('/subyek') }}"><i class="fa fa-list-ol"></i> RT</a></li>
            </ul>
          </li>
        </ul>
      </li>
