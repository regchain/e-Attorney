<div class="bs-example" data-example-id="collapse-accordion">
  ...
  @foreach ($cases as $case)
		<div class="panel panel-default">    
          ...
          <div class="pull-right"> Pemulihan Aset: Rp. {{ $case->pemulihan_aset }} ,-</div>
        </h4>
			</div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{ route('obyek.edit', [$case->id, $surat->id]) }}" class="btn btn-success btn-xs"> <i class="fa fa-edit"> &nbsp; </i> Edit</a><p> Rp. {{ $surat->nilai_pemulihan_aset }} ,-</p></td>
              </tr>
              @empty
              <tr>
